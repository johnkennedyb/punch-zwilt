...
const Risk = () => {
  return (
    ...
    >
      ...
      <div className="w-full  flex flex-row lg:flex-row items-center justify-between relative lg:absolute lg:right-0 px-10 lg:px-12 rounded-lg py-8 lg:py-12 overflow-hidden bg-white shadow-md">
      <div className="w-full lg:w-1/4 mb-8 lg:mb-0">
        ...
        <div className="mt-4 text-sm lg:text-base lg:w-1/3">
          We take complex hiring processes - and simplify them.<br/> Connecting you
          to the world’s highly qualified talent pool.
        </div>
      </div><div className="lg:w-3/4 bg-white shadow-md">
